...
This document provides guidelines for internationalization of the Bloqcoin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bloqcoin_en.ts` remains unchanged.
