...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bloqcoin bloqcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bloqcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bloqcoin transaction") + "\n" +
              "  bloqcoin-tx [options] -create [commands]   " + _("Create hex-encoded bloqcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bloqcoin transaction
