...
#define BOOST_TEST_MODULE Bloqcoin Test Suite

#include "test_bloqcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bloqcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
