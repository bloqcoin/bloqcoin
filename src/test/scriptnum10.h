...
#ifndef BLOQCOIN_TEST_SCRIPTNUM10_H
#define BLOQCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bloqcoin 0.10.0, for cross-comparison.
 */
public:
