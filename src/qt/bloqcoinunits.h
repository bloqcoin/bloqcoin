...
#ifndef BLOQCOIN_QT_BLOQCOINUNITS_H
#define BLOQCOIN_QT_BLOQCOINUNITS_H
...
/** Bloqcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BloqcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BloqcoinUnits(QObject *parent);

    /** Bloqcoin units.
      @note Source: https://en.bloqcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BLOQ,
...
typedef BloqcoinUnits::Unit BloqcoinUnit;

#endif // BLOQCOIN_QT_BLOQCOINUNITS_H
