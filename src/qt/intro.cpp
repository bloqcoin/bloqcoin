...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bloqcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bloqcoin"),
     ...
     * override -datadir in the bloqcoin.conf file in the default data directory
     * (to be consistent with bloqcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
